...
<div class="layui-tab nav" lay-filter="test1">
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show"><div id="owl-demo" class="owl-carousel">
        ...
        <div class="layui-tab-item"><div class="index_box">
            <div class="index_hot with_1200">
                <dt class="index_nav">一周特价</dt>
                <dd class="index_tejia wi_fff">
                    <ul>
    ...
    $(function () {
        layui.use('element', function(){
            ...
            element.on('tab(test1)', function(){
                ...
                // var $li = $(".nav_box li[lay-id ="+id+"]");
                // $(".nav_box li").attr("id","");
                // $li.attr("id","nav_hover");
                // console.log($li);
            });
        });
        //轮播图控制
